...
const Comment = ({ slug, id }: { slug: string, id:string }) => {
    ...
    return (
        <div className="comment-section">
            ...
            {
                loading ? (<div className="skLoading">
                    <Skeleton className="title" />
                    <Skeleton count={4} />
                </div>) : comment.length < 1 ? <div className="not-found">No comment for this blog</div> : (comment.map((commentData, i) => <CommentCard key={i} {...commentData} />))
            }
                        ...
                        <form ref={formRef} onSubmit={handleSubmit}>
                            <div className="modalBody">
                                ...
                                <div className="input-group">
                                    ...
                                    <input type="text" required name="comment" placeholder="Enter your comment" />
                                </div>
                                <br />
                            </div>
